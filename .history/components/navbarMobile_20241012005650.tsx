...
export function NavbarMobile() {
  return (
    <div className="relative lg:hidden">
      <div className="fixed flex items-center justify-between bottom-[10px] left-[10px] h-[80px] px-[30px] w-[calc(100vw-20px)] bg-gradient-to-b from-red-300 to-gray-200 from z-20 rounded-full">
        <BoutonMenu
...
function BoutonMenu({ icone, href }: BoutonProps) {
  return (
    <Link href={href} className="h-[45px] w-[45px] bg-white rounded-full p-[8px]">
      {icone}
    </Link>
  );
}
