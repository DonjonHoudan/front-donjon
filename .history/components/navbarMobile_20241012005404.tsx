...
export function NavbarMobile() {
  return (
    <div className="relative lg:hidden">
      <div className="fixed flex items-center justify-between bottom-0 left-0 h-[80px] px-[30px] w-full bg-gradient-to-b from-gray-300 to-white from z-20 rounded-xl">
        <BoutonMenu
