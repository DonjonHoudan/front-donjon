...
export function NavbarMobile() {
  return (
    <div className="relative lg:hidden">
      <div className="fixed flex items-center justify-between bottom-[10px] left-[10px] h-[80px] px-[30px] w-[calc(100vw-20px)] bg-gradient-to-b from-red-300 to-gray-200 from z-20 rounded-6xl">
        <BoutonMenu
