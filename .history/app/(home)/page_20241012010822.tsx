...
export default async function Home() {
  ...
  return (
    <section className="relative h-[calc(100vh-75px)]">
      ...
      <div
        className={cn(
          "absolute top-[15vh] flex justify-content object-cover z-10",
          "lg:top-[5vh] md:right-[10vw]"
        )}
      >
        {data?.article.data.attributes.slug && (
          <Link href={`actualites/${data.article.data.attributes.slug}`} className="relative block w-[350px] h-[500px] lg:w-[450px] lg:h-[636px]">
            <ImageStrapi
